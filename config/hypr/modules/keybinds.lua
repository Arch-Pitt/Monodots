...
hl.bind(mainMod .. " + F1", hl.dsp.exec_cmd("swayosd-client --output-volume mute-toggle"))
hl.bind(mainMod .. " + F2", hl.dsp.exec_cmd("swayosd-client --output-volume -5"))
hl.bind(mainMod .. " + F3", hl.dsp.exec_cmd("swayosd-client --output-volume +5"))

hl.bind(mainMod .. " + F11", hl.dsp.exec_cmd("swayosd-client --brightness -10"))
hl.bind(mainMod .. " + F12", hl.dsp.exec_cmd("swayosd-client --brightness +10"))